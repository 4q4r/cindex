...
const exampleQueries = [
  { query: 'deep learning medical imaging', description: 'ИИ в медицинской визуализации' },
  { query: 'CRISPR Huntington', description: 'CRISPR при болезни Хантингтона' },
  { query: 'ocean acidification coral reef', description: 'Влияние закисления океана на рифы' },
  { query: 'antibiotic resistance agriculture', description: 'Антибиотикорезистентность в агросекторе' },
  { query: 'машинное обучение прогнозирование', description: 'Русскоязычные публикации по ML' },
];
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 animate-fade-in">
        <div className="max-w-lg w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-text-primary mb-3">Поиск научных источников</h2>
          <p className="text-sm text-text-secondary mb-8 leading-relaxed max-w-md mx-auto">
            Ищите релевантные peer-reviewed публикации и сразу получайте полный фрагмент,
            проверку критериев и готовое цитирование по ГОСТ.
          </p>
          <div className="text-left space-y-3">
            <h3 className="text-[11px] uppercase tracking-wider text-text-tertiary text-center mb-4">Примеры запросов</h3>
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 animate-fade-in">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-lg font-semibold text-text-primary mb-2">Ничего не найдено</h2>
          <p className="text-sm text-text-secondary mb-6 leading-relaxed">Измените запрос или ослабьте фильтры.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 animate-fade-in">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-lg font-semibold text-text-primary mb-2">Ошибка поиска</h2>
          <p className="text-sm text-text-secondary mb-6 leading-relaxed">
            Не удалось выполнить поиск. Проверьте доступность сервисов и повторите попытку.
          </p>
          <button
            onClick={onRetry}
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 animate-fade-in">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-lg font-semibold text-text-primary mb-2">Частичный результат</h2>
          <p className="text-sm text-text-secondary mb-4 leading-relaxed">
            Часть источников недоступна. Показаны результаты только из доступных площадок.
          </p>
          <div className="bg-bg-card border border-border-default rounded-lg p-4 mb-5">
            <h3 className="text-[11px] uppercase tracking-wider text-text-tertiary mb-2">Недоступные источники</h3>
            {sourcesFailed.map((s) => (
