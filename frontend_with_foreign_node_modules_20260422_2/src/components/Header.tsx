      ...
      <div className="max-w-[1440px] mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold tracking-tight text-text-primary">CIndex</h1>
          </div>
          <span className="text-xs text-text-tertiary border-l border-border-default pl-3">Поиск источников для цитирования</span>
        </div>
            ...
            <>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={sourcesFailed.length > 0 ? 'text-warning' : 'text-success'}>
                  Источники: {activeSources}/{sourcesQueried} {sourcesFailed.length > 0 ? '(частично)' : '(доступны)'}
                </span>
              </div>
            </>
          )}
